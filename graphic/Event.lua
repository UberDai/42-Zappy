...
-- :ddddddddddhyyddddddddddd: Modified: 2015-06-04 02:57:04
...
e['n'] = function () zappy:addPlayer(Player('team 1', love.math.random(0, zappy.widthMap), love.math.random(0, zappy.heightMap), 'north')) end
