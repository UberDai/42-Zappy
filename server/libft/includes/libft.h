...
/*   Updated: 2015/05/21 02:51:21 by amaurer          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define FT_M_PI	3.141592653589793
...
char				*ft_strreplace(const char *str, const char *ptrn,
	const char *rplce);
...
void				ft_lstusort(t_list **lst, int (*f)(t_list *lst1,
	t_list *lst2));
